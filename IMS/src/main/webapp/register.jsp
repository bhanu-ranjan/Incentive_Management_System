...
<head>
	...
	<title>Incentive Mgmt Sys Register Page</title>
</head>
...
<body>
	...
	<div class="container">
		...
		<form action="reg" method="post" >
			...
			<input type="text" id="name" placeholder="enter your full name" name="name" required/><br />
			<label for="mobile">Mobile:</label>
			<input type="tel" id="mobile" placeholder="enter your mobile" name="mobile" required /><br />
